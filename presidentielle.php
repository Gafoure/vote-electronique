...
// Récupérer l'electionID de l'élection de type "présidentielle"
$sql_election = "SELECT electionID FROM election WHERE TypeElection='présidentielle'";
...
if ($result_election->num_rows > 0) {
    ...
    if ($validElection) {
        // Récupérer les candidatID assignés à cette élection présidentielle
        ...
        if ($result_candidates->num_rows > 0) {
            ...
            $result = null; // Pas de candidats assignés à cette élection présidentielle
        }
    }
} else {
    $result = null; // Pas d'élection de type "présidentielle" trouvée
}
?>
...
<body>
<div class="container">
    <h1 class="mt-5 text-center">Vote présidentielle</h1>
    <form action="submit_vote.php" method="post" id="voteForm">
        ...
        <?php if ($validElection): ?>
            ...
            <?php else: ?>
                <div class="alert alert-info text-center">Aucun candidat trouvé pour l'élection présidentielle.</div>
            <?php endif; ?>
        <?php else: ?>
