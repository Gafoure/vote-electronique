...
// Récupérer l'electionID de l'élection municipale pour la Commune V
$sql_election = "SELECT electionID FROM election WHERE TypeElection='Commune V'";
...
<body>
<div class="container">
    <h1 class="mt-5 text-center">Vote Municipale pour la Commune V</h1>
    <form action="submit_vote.php" method="post" id="voteForm">
        ...
        <?php if ($validElection): ?>
            ...
            <?php else: ?>
                <div class="alert alert-info text-center">Aucun candidat trouvé pour l'élection de la Commune V.</div>
            <?php endif; ?>
        <?php else: ?>
