...
// Récupérer l'electionID de l'élection de type "legislative"
$sql_election = "SELECT electionID FROM election WHERE TypeElection='Legislative'";
...
<body>
<div class="container">
    <h1 class="mt-5 text-center">Vote Legislative</h1>
    <form action="submit_vote.php" method="post" id="voteForm">
        ...
        <?php if ($validElection): ?>
            ...
            <?php else: ?>
                <div class="alert alert-info text-center">Aucun candidat trouvé pour l'élection legislative.</div>
            <?php endif; ?>
        <?php else: ?>
